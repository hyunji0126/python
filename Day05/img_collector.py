...
# 다음 이미지 기본 URL
base = 'https://search.daum.net/search?w=tot&DA=YZR&t__nil_searchbox=btn&sug=&sugo=&sq=&o=&q='
...
# 모든 브라우저에서 모든 서버에게 정확한 요청을 전달하기 위해
# URL Encoding이 필요합니다.
# URL에는 아스키 코드를 이용한 문자만 전달이 가능하기 떄문에
# 타 언어로 작성된 문자를 변환해서 전달해야 합니다.
...
# 다운로드 완료 후 다운로드 폴더를 자동으로 열어주는 행위
